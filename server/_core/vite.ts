...
export function serveStatic(app: Express) {
  ...
  // Hashed assets (JS/CSS/images with content hash in filename): 1-year immutable cache
  // These files are safe to cache forever because filenames change on content update

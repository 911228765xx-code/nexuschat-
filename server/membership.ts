...
export const MEMBERSHIP_TIERS: MembershipTier[] = [
  ...
  },
  {
    ...
    benefits: { maxGroups: 10, maxGroupMembers: 500, aiDailyFree: 30, maxFileMB: 100, maxVideoMB: 120, adFree: true, badge: "Plus" },
    perks: ["建群上限 10 个", "群人数上限 500", "每日 30 次免费 AI", "文件 ≤ 100MB", "视频 ≤ 120MB", "免广告", "Plus 专属徽章"],
  },
  {
    key: "pro", name: "高级会员 Pro", monthlyNN: 299, color: "#F59E0B", tagline: "专业玩家 / KOL",
    benefits: { maxGroups: 50, maxGroupMembers: 2000, aiDailyFree: 200, maxFileMB: 500, maxVideoMB: 250, adFree: true, badge: "Pro" },
    perks: ["建群上限 50 个", "群人数上限 2000", "每日 200 次免费 AI", "文件 ≤ 500MB", "视频 ≤ 250MB", "免广告", "Pro 金色徽章", "AI 优先响应"],
  },
];

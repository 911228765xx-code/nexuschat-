          ...
          <div className="flex items-center gap-3 px-4 py-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[13px] px-2.5 py-1 rounded-full bg-neon-green/10 text-neon-green border border-neon-green/20">{t("settings.current")}</span>
                </div>
                <p className="text-xs text-muted-foreground">{t("settings.activeSession") || "Active session"}</p>
              </div>
            </div>
        </div>
      </div>
        ...
        <div className="p-3.5 rounded-2xl bg-card/50 border border-border/20">
          ...
          >
            ...
            <div className="flex-1 text-left">
              ...
              <p className="text-xs text-muted-foreground">{t("settings.blockedUsersDesc")}</p>
            </div>
    ...
    <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-xs text-muted-foreground mt-2">{t("settings.version")} 2.1.0</p>
          <p className="text-xs text-muted-foreground mt-0.5">{t("settings.buildDate")}: 2026-02-27</p>
        </div>
        ...
        <div className="text-center mt-8 pb-4">
          <p className="text-xs text-muted-foreground">© 2026 NexusChat. All rights reserved.</p>
          <p className="text-xs text-muted-foreground mt-2">{t("settings.builtWith")}</p>
        </div>
      </div>
    </motion.div>
  );
  ...
  const renderMain = () => (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
        {/* Account Section */}
        <div>
          <h3 className="text-xs text-muted-foreground font-medium mb-2 px-2">{t("settings.account")}</h3>
        ...
        {/* Preferences Section */}
        <div>
          <h3 className="text-xs text-muted-foreground font-medium mb-2 px-2">{t("settings.preferences")}</h3>
          <div className="rounded-2xl bg-card/50 border border-border/20 overflow-hidden divide-y divide-border/10">
            {/* Theme */}
            <button
              onClick={() => toggleTheme?.()}
        ...
        {/* About & Support */}
        <div>
          <h3 className="text-xs text-muted-foreground font-medium mb-2 px-2">{t("settings.support")}</h3>
          <div className="rounded-2xl bg-card/50 border border-border/20 overflow-hidden divide-y divide-border/10">
            <button
        ...
        <div className="text-center py-2">
          <p className="text-xs text-muted-foreground/40 font-mono">NexusChat v2.1.0 (Build 2026.02)</p>
          <p className="text-xs text-muted-foreground/30 mt-0.5">{t("settings.builtWith")}</p>
        </div>

    ...
    <div className="flex flex-col h-full bg-background">
      ...
      <header className="glass sticky top-0 z-20 px-4 pt-[env(safe-area-inset-top)] border-b border-border/30">
        <div className="flex items-center gap-3 h-14">
          ...
          <button
            onClick={handleSave}
            disabled={!hasChanges}
            className={`flex items-center gap-2.5 px-4 py-1.5 rounded-xl text-xs font-medium transition-all ${
              hasChanges
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="flex flex-col items-center py-6">
          ...
          <p className="text-xs text-muted-foreground mt-2">{t("editProfile.tapToChange") || "Tap to change avatar"}</p>
        </div>
        ...
        <div className="px-4 space-y-5 pb-8">
          ...
          <div>
            ...
            <input
              ...
              maxLength={30}
            />
            <p className="text-xs text-muted-foreground mt-2 px-2">{displayName.length}/30</p>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              maxLength={200}
            />
            <p className="text-xs text-muted-foreground mt-2 px-2">{bio.length}/200</p>
          </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-2 px-2">
              ...
              <button
                ...
                className="text-xs text-neon-cyan hover:underline flex items-center gap-2"
              >
                <Plus size={10} />
              ...
              {showAddSocial && (
                ...
                >
                  <div className="p-3.5 rounded-xl bg-card border border-neon-cyan/20 space-y-3">
                    {/* Platform selector */}
                    <div>
                      <label className="text-xs text-muted-foreground mb-2.5 block">Platform</label>
                    ...
                    {/* URL input */}
                    <div>
                      <label className="text-xs text-muted-foreground mb-2.5 block">URL</label>
                      <input
                        type="url"
                        value={newSocialUrl}
          ...
          {/* SBT & Badges */}
          <div>
            <label className="text-xs text-muted-foreground mb-2 block px-2">
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                >
                  ...
                  <span className={`text-xs font-medium text-${badge.color}`}>{badge.name}</span>
                </div>
              ))}
            </div>
          </div>
